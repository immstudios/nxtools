...
class FileObject:
    ...
    @property
    def base_name(self):
        """Return the base name (without a directory and an extension)."""
...
def get_path_pairs(
    ...
    """For each file in `input_dir` and yield a tuple of (input, output).

    This function is useful for batch conversion,
    when you need to process files from `input_dir`
